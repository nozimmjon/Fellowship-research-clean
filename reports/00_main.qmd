...
Notes: All specifications include region, cohort, and wave fixed effects. Standard errors are clustered at the region level. The minimal specification includes only the parental term and fixed effects, the demographic specification adds urban residence and female, and the extended specification adds the selected current household controls.
