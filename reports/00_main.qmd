...
This paper studies intergenerational educational mobility in Uzbekistan using the 2010, 2016, and 2022-23 waves of the Life in Transition Survey (LiTS). The national rank-rank slope rises from `r fmt_num(metric_est("rank_rank_slope", 2010))` in 2010 to `r fmt_num(metric_est("rank_rank_slope", 2016))` in 2016 and is `r fmt_num(metric_est("rank_rank_slope", 2022))` in 2022-23; the 2010-to-2016 increase is statistically significant (p = `r fmt_p(rank_change_value("2010_to_2016", "p.value"))`), while the 2016-to-2022 difference is not (p = `r fmt_p(rank_change_value("2016_to_2022", "p.value"))`). Parental education is the most stable predictor of attainment across nested pooled specifications. A bounded child-module extension shows widespread pandemic-era disruption and heavy reliance on maternal support, but no robust adjusted gap by parental education. Missingness sensitivity and few-cluster bootstrap inference preserve the qualitative wave ordering. The contribution is a reproducible three-wave mobility profile for a setting with no prior multi-wave evidence, using locked measures, transparent missingness audits, and region-clustered inference with wild-bootstrap robustness.
...
Uzbekistan is an important setting for this question. The country combines a young population, persistent regional inequality, and a policy agenda centered on human capital and productivity growth. Since 2017, Uzbekistan has undergone a rapid higher-education expansion: the number of higher education institutions nearly doubled from 119 in 2019/20 to 222 by 2024/25, while total enrolled students rose from approximately 441,000 to over 1.4 million [@uzb_admin_he_2025]. This expansion, together with market transition, urbanization, and digital change, has altered both the returns to schooling and the ways households support children's learning. Whether this transformation reduces intergenerational persistence or coexists with durable family-background gradients is an open empirical question.

Despite growing comparative evidence on educational mobility in developing and transition economies, no reproducible multi-wave profile exists for Uzbekistan. The closest Central Asian comparator in the published literature is Kyrgyzstan, while broader post-socialist and developing-country studies establish useful benchmarks but do not substitute for country-specific measurement. Existing Uzbekistan evidence remains weighted toward sector diagnostics and policy discussion rather than a structured intergenerational profile.

This paper uses LiTS repeated cross-sections from 2010, 2016, and 2022-23 to provide this missing profile. It makes three contributions. First, it documents national mobility patterns using a locked bundle of measures: a rank-rank slope, upward mobility, downward mobility, and same-category persistence. Second, it estimates a nested sequence of pooled associational models that separates pre-determined demographics from potentially endogenous current household controls. Third, it adds a short LiTS IV child-module extension on pandemic-era disruption and support patterns. The headline findings are that the rank-rank slope rises sharply from `r fmt_num(metric_est("rank_rank_slope", 2010))` in 2010 to `r fmt_num(metric_est("rank_rank_slope", 2016))` in 2016, with the 2022-23 level at `r fmt_num(metric_est("rank_rank_slope", 2022))`; parental education is the most stable pooled correlate of attainment; and pandemic-era disruption was widespread but the adjusted parental-education gap in education stoppage is fragile. The claims are descriptive and associational throughout — Module A documents levels and trends, Module B estimates conditional associations, and Module C provides bounded non-causal evidence on household learning conditions.

Section 2 positions the paper in the literature, Section 3 describes the data and measurement choices, Sections 4-7 present the empirical design and results, and Sections 8-10 discuss interpretation, limitations, and conclusion.
...
The descriptive pattern is that most household support indicators are similar across expansion groups, with two notable exceptions: low-expansion regions have higher emigration and remittance receipt rates (by roughly 5 percentage points), while among remittance-receiving households, those in high-expansion regions allocate remittances toward education at a substantially higher rate. These patterns are consistent with a setting where migration and education investment operate as complementary household strategies, but they do not identify a causal expansion effect.
...
First, Uzbekistan exhibits substantial intergenerational educational persistence. The sharpest increase in the parent-child gradient occurs between 2010 and 2016, and the pooled associational models reproduce that mid-period shift across all three nested specifications.
...
Third, the pandemic mechanism evidence reinforces the practical importance of household learning conditions. Device sharing, internet quality, and time- or cost-related constraints were common, and support was overwhelmingly provided by mothers. What the child module establishes most clearly is the scale of disruption and household substitution, not a robust adjusted stoppage gap by parental education.

To place these findings in comparative perspective, the Uzbekistan rank-rank slopes fall within the range documented in cross-country studies of educational mobility. Hertz et al. [-@hertz_2008] report intergenerational education correlations spanning roughly 0.20 to 0.60 across developing and developed countries. The Uzbekistan trajectory — from approximately `r fmt_num(metric_est("rank_rank_slope", 2010))` in 2010 to `r fmt_num(metric_est("rank_rank_slope", 2016))` in 2016 — places it in the moderate-to-high range for developing settings, comparable to patterns observed in other post-Soviet economies rather than the higher-mobility profiles of Western European comparators. The mid-period strengthening is consistent with evidence from Turkey and other middle-income settings where educational expansion coexists with durable family-background gradients at upper schooling levels [@aydemir_yazici_2019; @narayan_etal_2018]. One caveat is that the 2010-to-2016 increase could partly reflect measurement improvement — the 2010 wave uses a different parental-education question format and has substantially higher missingness — rather than purely substantive change, even though the sensitivity bounds preserve the qualitative wave ordering.
...
These limitations do not undermine the central contribution, but they shape the scope of the conclusions.

## Conclusion

This paper provides structured multi-wave evidence on intergenerational educational mobility in Uzbekistan using LiTS 2010, 2016, and 2022-23. The results indicate substantial and persistent educational inheritance. The rank-rank evidence points to a clear mid-period increase in persistence, with the 2022-23 gradient remaining elevated but not precisely distinguishable from either the 2010 or 2016 levels. Parental education remains the strongest and most stable predictor of attainment in every pooled specification.
